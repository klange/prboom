...
static void D_DoomMainSetup(void)
{
  ...
  fprintf(stderr, "okay, stuff!\n");

  fprintf(stderr, "Netgame: %d\n", netgame);
  fprintf(stderr, "Autostart: %d\n", autostart);
  fprintf(stderr, "Singledemo: %d\n", singledemo);
